...
`~/.hermes-agent/auth/office365-accounts.json`
...
- `~/.hermes-agent/auth/office365/primary.json`
- `~/.hermes-agent/auth/office365/work.json`
...
- **Client secrets** are stored in `~/.hermes-agent/auth/office365-accounts.json` with mode `0600` (owner read/write only)
